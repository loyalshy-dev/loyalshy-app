...
**Strategic pivot 2026-04-27**: cut from 7 pass types + public REST API to 2 types + staff-app-only API. See `.Codex/memory/project_pivot_loyalty_only.md` for the full context.
...
The full rewrite plan is in `.Codex/plans/happy-growing-stroustrup.md`. Phases:
...
```
Read AGENTS.md, then read the plan in .Codex/plans/happy-growing-stroustrup.md.
Continue development from where we left off. Check current progress
in AGENTS.md and build Phase [PX].
```
