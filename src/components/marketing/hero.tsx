        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start gap-8">
            ...
            <div className="hero-fade-in" style={{ animationDelay: "0ms" }}>
              <div
                className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[13px] font-bold tracking-wider"
                style={{
            ...
            <div className="hero-fade-in" style={{ animationDelay: "300ms" }}>
              <div className="flex flex-wrap items-center gap-4">
                <Link href="/register" className="mk-btn-primary py-4! px-8! text-base! gap-2 shadow-xl!">
                  {tCommon("getStartedFree")}
                  <ArrowRight className="size-4" />
                </Link>
                <Link href="#features" className="mk-btn-ghost py-4! px-8! text-base!">
                  {t("seeHowItWorks")}
                </Link>
                <span
