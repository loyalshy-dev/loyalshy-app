...
export async function MarketingFooter() {
  ...
  const SOCIAL_LINKS = [
    { label: t("instagram"), href: "https://instagram.com/loyalshy", Icon: InstagramIcon },
    { label: t("tiktok"), href: "https://tiktok.com/@loyalshy_", Icon: TikTokIcon },
  ]
              ...
              {SOCIAL_LINKS.map(({ label, href, Icon }) => (
                <li key={label}>
                  <a
                    ...
                    aria-label={label}
                    className="inline-flex rounded-sm transition-colors duration-150 hover:text-[oklch(0.55_0.17_155)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
